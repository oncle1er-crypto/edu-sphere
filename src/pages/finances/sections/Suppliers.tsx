...
const suppliers = [
  { name: "Librairie Etoile", category: "Fournitures pédagogiques", balance: "0", contact: "+225 01 01 11 22 33", status: "Actif" },
  { name: "CIE", category: "Énergie", balance: "187 500", contact: "service@cie.ci", status: "Actif" },
  { name: "SODECI", category: "Eau", balance: "62 000", contact: "+225 07 08 99 88 77", status: "Actif" },
  { name: "Garage Auto+", category: "Maintenance véhicules", balance: "245 000", contact: "+225 05 06 12 34 56", status: "Actif" },
  { name: "Marché Mokolo", category: "Cantine", balance: "0", contact: "—", status: "Actif" },
  { name: "Orange Côte d'Ivoire", category: "Télécoms / Internet", balance: "85 000", contact: "pro@orange.ci", status: "Actif" },
];
